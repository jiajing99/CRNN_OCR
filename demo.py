...
def parse_arg():
    ...
    parser.add_argument('--checkpoint', type=str, default='output/checkpoints/checkpoint_15_acc_0.9969.pth',
...
# python demo.py --image_path result.jpg --checkpoint output/OWN/crnn/2020-12-11-16-41/checkpoints/checkpoint_2_acc_0.9937.pth
def recognition(config, img, model, converter, device):
    ...
    img = (img / 255. - np.array(config.DATASET.MEAN, dtype=np.float32)) / np.array(config.DATASET.STD, dtype=np.float32)
    ...
    with open('result.txt', 'w', encoding='utf-8') as f:
        f.write("addition.jpg 皖ASU994\n")
        f.write("result.jpg " + sim_pred + "\n")
